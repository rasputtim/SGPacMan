...
#include "SDL.h"
#include <math.h>
#include "include\sgeresource.h"
#include "include\sgesprite.h"
#include "include\sgegfx.h"
...
typedef struct {
	...
	CDynamicArray<SGEBITMAPFONTINFO *> info;
...
typedef struct {
	...
	CDynamicArray<SGESPRITE *> textSprites;
	Uint32 preDelay;
	Uint32 postDelay;
