...
\returns Returns 0 on success, -1 on failure.
*/
int pixelColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return pixelRGBAText(renderer, x, y, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result = 0;
...
\returns Returns 0 on success, -1 on failure.
*/
int pixelRGBAWeightText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a, Uint32 weight)
{
	/*
	...
	*/
	...
	return pixelRGBAText(renderer, x, y, r, g, b, a);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineText(SDL_Renderer * renderer, Sint16 x1, Sint16 x2, Sint16 y)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 x2, Sint16 y, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return hlineRGBAText(renderer, x1, x2, y, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int hlineRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 x2, Sint16 y, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result = 0;
	result |= SDL_SetRenderDrawBlendMode(renderer, (a == 255) ? SDL_BLENDMODE_NONE : SDL_BLENDMODE_BLEND);
	result |= SDL_SetRenderDrawColor(renderer, r, g, b, a);
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y1, Sint16 y2, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return vlineRGBAText(renderer, x, y1, y2, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int vlineRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y1, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result = 0;
	result |= SDL_SetRenderDrawBlendMode(renderer, (a == 255) ? SDL_BLENDMODE_NONE : SDL_BLENDMODE_BLEND);
	result |= SDL_SetRenderDrawColor(renderer, r, g, b, a);
...
\returns Returns 0 on success, -1 on failure.
*/
int rectangleColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return rectangleRGBAText(renderer, x1, y1, x2, y2, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int rectangleRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	Sint16 tmp;
	SDL_Rect rect;
	...
	*/
	if (x1 == x2) {
		if (y1 == y2) {
			return (pixelRGBAText(renderer, x1, y1, r, g, b, a));
		} else {
			return (vlineRGBAText(renderer, x1, y1, y2, r, g, b, a));
		}
	} else {
		if (y1 == y2) {
			return (hlineRGBAText(renderer, x1, x2, y1, r, g, b, a));
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedRectangleColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return roundedRectangleRGBAText(renderer, x1, y1, x2, y2, rad, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedRectangleRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result = 0;
	Sint16 tmp;
	Sint16 w, h;
	...
	*/
	if (rad <= 1) {
		return rectangleRGBAText(renderer, x1, y1, x2, y2, r, g, b, a);
	}
	...
	*/
	...
	yy1 = y1 + rad;
	yy2 = y2 - rad;
	result |= arcRGBAText(renderer, xx1, yy1, rad, 180, 270, r, g, b, a);
	result |= arcRGBAText(renderer, xx2, yy1, rad, 270, 360, r, g, b, a);
	result |= arcRGBAText(renderer, xx1, yy2, rad,  90, 180, r, g, b, a);
	result |= arcRGBAText(renderer, xx2, yy2, rad,   0,  90, r, g, b, a);

	/*
	* Draw lines
	*/
	if (xx1 <= xx2) {
		result |= hlineRGBAText(renderer, xx1, xx2, y1, r, g, b, a);
		result |= hlineRGBAText(renderer, xx1, xx2, y2, r, g, b, a);
	}
	if (yy1 <= yy2) {
		result |= vlineRGBAText(renderer, x1, yy1, yy2, r, g, b, a);
		result |= vlineRGBAText(renderer, x2, yy1, yy2, r, g, b, a);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedBoxColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return roundedBoxRGBAText(renderer, x1, y1, x2, y2, rad, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int roundedBoxRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2,
	Sint16 y2, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	*/
	do {
		...
		if (ocy != cy) {
			if (cy > 0) {
				ypcy = y + cy;
				ymcy = y - cy;
				result |= hlineText(renderer, xmcx, xpcx + dx, ypcy + dy);
				result |= hlineText(renderer, xmcx, xpcx + dx, ymcy);
			} else {
				result |= hlineText(renderer, xmcx, xpcx + dx, y);
			}
			ocy = cy;
		}
		if (ocx != cx) {
			if (cx != cy) {
				if (cx > 0) {
					ypcx = y + cx;
					ymcx = y - cx;
					result |= hlineText(renderer, xmcy, xpcy + dx, ymcx);
					result |= hlineText(renderer, xmcy, xpcy + dx, ypcx + dy);
				} else {
					result |= hlineText(renderer, xmcy, xpcy + dx, y);
				}
			}
			ocx = cx;
		}
	...
	/* Inside */
	if (dx > 0 && dy > 0) {
		result |= boxRGBAText(renderer, x1, y1 + rad + 1, x2, y2 - rad, r, g, b, a);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int boxColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return boxRGBAText(renderer, x1, y1, x2, y2, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int boxRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	Sint16 tmp;
	SDL_Rect rect;
...
\returns Returns 0 on success, -1 on failure.
*/
int lineText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2)
{
	/*
	* Draw
	*/
...
\returns Returns 0 on success, -1 on failure.
*/
int lineColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return lineRGBAText(renderer, x1, y1, x2, y2, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int lineRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw
	*/
...
\returns Returns 0 on success, -1 on failure.
*/
int _aalineRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a, int draw_endpoint)
{
	...
	if (dx == 0) {
		...
		*/
		if (draw_endpoint)
		{
			...
			if (dy > 0) {
				return (vlineRGBAText(renderer, x1, yy0, yy0+dy, r, g, b, a));
			} else {
				return (pixelRGBAText(renderer, x1, y1, r, g, b, a));
			}
		}
		...
		*/
		if (draw_endpoint)
		{
			...
			if (dx > 0) {
				return (hlineRGBAText(renderer, xx0, xx0+dx, y1, r, g, b, a));
			} else {
				return (pixelRGBAText(renderer, x1, y1, r, g, b, a));
			}
		}
		...
		*/
		return (lineRGBAText(renderer, x1, y1, x2, y2,  r, g, b, a));
	}
	...
	*/
	result |= pixelRGBAText(renderer, x1, y1, r, g, b, a);
		...
		*/
		...
		while (--dy) {
			...
			*/
			...
			result |= pixelRGBAWeightText (renderer, xx0, yy0, r, g, b, a, 255 - wgt);
			result |= pixelRGBAWeightText (renderer, x0pxdir, yy0, r, g, b, a, wgt);
		}
		...
		*/
		...
		while (--dx) {
			...
			*/
			wgt = (erracc >> intshift) & 255;
			result |= pixelRGBAWeightText (renderer, xx0, yy0, r, g, b, a, 255 - wgt);
			result |= pixelRGBAWeightText (renderer, xx0, y0p1, r, g, b, a, wgt);
		}
	}
	...
	*/
	if (draw_endpoint) {
		...
		* need to be weighted.
		*/
		result |= pixelRGBAText (renderer, x2, y2, r, g, b, a);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int aalineColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return _aalineRGBAText(renderer, x1, y1, x2, y2, c[0], c[1], c[2], c[3], 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aalineRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return _aalineRGBAText(renderer, x1, y1, x2, y2, r, g, b, a, 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int circleColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return ellipseRGBAText(renderer, x, y, rad, rad, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int circleRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return ellipseRGBAText(renderer, x, y, rad, rad, r, g, b, a);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int arcColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return arcRGBAText(renderer, x, y, rad, start, end, c[0], c[1], c[2], c[3]);
}
...
int arcRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	Sint16 cx = 0;
	Sint16 cy = rad;
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return aaellipseRGBAText(renderer, x, y, rad, rad, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aacircleRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw
	*/
	return aaellipseRGBAText(renderer, x, y, rad, rad, r, g, b, a);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return filledEllipseRGBAText(renderer, x, y, rad, rad, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledCircleRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	Sint16 cx = 0;
	Sint16 cy = rad;
	...
	do {
		...
		if (ocy != cy) {
			if (cy > 0) {
				ypcy = y + cy;
				ymcy = y - cy;
				result |= hlineText(renderer, xmcx, xpcx, ypcy);
				result |= hlineText(renderer, xmcx, xpcx, ymcy);
			} else {
				result |= hlineText(renderer, xmcx, xpcx, y);
			}
			ocy = cy;
		}
		if (ocx != cx) {
			if (cx != cy) {
				if (cx > 0) {
					ypcx = y + cx;
					ymcx = y - cx;
					result |= hlineText(renderer, xmcy, xpcy, ymcx);
					result |= hlineText(renderer, xmcy, xpcy, ypcx);
				} else {
					result |= hlineText(renderer, xmcy, xpcy, y);
				}
			}
			ocx = cx;
		}
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return ellipseRGBAText(renderer, x, y, rx, ry, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int ellipseRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int ix, iy;
	int h, i, j, k;
	...
	*/
	if (rx == 0) {
		return (vlineRGBAText(renderer, x, y - ry, y + ry, r, g, b, a));
	}
	/*
	* Special case for ry=0 - draw a hlineText
	*/
	if (ry == 0) {
		return (hlineRGBAText(renderer, x - rx, x + rx, y, r, g, b, a));
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return aaellipseRGBAText(renderer, x, y, rx, ry, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aaellipseRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int i;
	...
	*/
	...
	/*
	* Special case for ry=0 - draw an hlineText
	*/
	if (ry == 0) {
		return (hlineRGBAText(renderer, x - rx, x + rx, y, r, g, b, a));
	}
	...
	/* "End points" */
	result |= pixelRGBAText(renderer, xp, yp, r, g, b, a);
	result |= pixelRGBAText(renderer, xc2 - xp, yp, r, g, b, a);
	result |= pixelRGBAText(renderer, xp, yc2 - yp, r, g, b, a);
	result |= pixelRGBAText(renderer, xc2 - xp, yc2 - yp, r, g, b, a);
	...
	for (i = 1; i <= dxt; i++) {
		...
		/* Upper half */
		xx = xc2 - xp;
		result |= pixelRGBAWeightText(renderer, xp, yp, r, g, b, a, iweight);
		result |= pixelRGBAWeightText(renderer, xx, yp, r, g, b, a, iweight);

		result |= pixelRGBAWeightText(renderer, xp, ys, r, g, b, a, weight);
		result |= pixelRGBAWeightText(renderer, xx, ys, r, g, b, a, weight);

		/* Lower half */
		yy = yc2 - yp;
		result |= pixelRGBAWeightText(renderer, xp, yy, r, g, b, a, iweight);
		result |= pixelRGBAWeightText(renderer, xx, yy, r, g, b, a, iweight);

		yy = yc2 - ys;
		result |= pixelRGBAWeightText(renderer, xp, yy, r, g, b, a, weight);
		result |= pixelRGBAWeightText(renderer, xx, yy, r, g, b, a, weight);
	}
	...
	for (i = 1; i <= dyt; i++) {
		...
		/* Right half */
		xx = xc2 - xs;
		result |= pixelRGBAWeightText(renderer, xs, yp, r, g, b, a, weight);
		result |= pixelRGBAWeightText(renderer, xx, yp, r, g, b, a, weight);

		result |= pixelRGBAWeightText(renderer, xs, yy, r, g, b, a, weight);
		result |= pixelRGBAWeightText(renderer, xx, yy, r, g, b, a, weight);
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return filledEllipseRGBAText(renderer, x, y, rx, ry, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledEllipseRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rx, Sint16 ry, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int ix, iy;
	int h, i, j, k;
	...
	if (rx > ry) {
		...
		do {
			...
			if ((ok != k) && (oj != k)) {
				...
				xmh = x - h;
				if (k > 0) {
					result |= hlineText(renderer, xmh, xph, y + k);
					result |= hlineText(renderer, xmh, xph, y - k);
				} else {
					result |= hlineText(renderer, xmh, xph, y);
				}
				ok = k;
			}
			if ((oj != j) && (ok != j) && (k != j)) {
				...
				xpi = x + i;
				if (j > 0) {
					result |= hlineText(renderer, xmi, xpi, y + j);
					result |= hlineText(renderer, xmi, xpi, y - j);
				} else {
					result |= hlineText(renderer, xmi, xpi, y);
				}
				oj = j;
			}
		...
		do {
			...
			if ((oi != i) && (oh != i)) {
				...
				xpj = x + j;
				if (i > 0) {
					result |= hlineText(renderer, xmj, xpj, y + i);
					result |= hlineText(renderer, xmj, xpj, y - i);
				} else {
					result |= hlineText(renderer, xmj, xpj, y);
				}
				oi = i;
			}
			if ((oh != h) && (oi != h) && (i != h)) {
				...
				xpk = x + k;
				if (h > 0) {
					result |= hlineText(renderer, xmk, xpk, y + h);
					result |= hlineText(renderer, xmk, xpk, y - h);
				} else {
					result |= hlineText(renderer, xmk, xpk, y);
				}
				oh = h;
			}
...
int _pieRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end,  Uint8 r, Uint8 g, Uint8 b, Uint8 a, Uint8 filled)
{
	int result;
	...
	*/
	...
	if (numpoints<3)
	{
		result = lineRGBAText(renderer, vx[0], vy[0], vx[1], vy[1], r, g, b, a);
	}
	else
	{
		...
		/* Draw */
		if (filled) {
			result = filledPolygonRGBAText(renderer, vx, vy, numpoints, r, g, b, a);
		} else {
			result = polygonRGBAText(renderer, vx, vy, numpoints, r, g, b, a);
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int pieColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
	Sint16 start, Sint16 end, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return _pieRGBAText(renderer, x, y, rad, start, end, c[0], c[1], c[2], c[3], 0);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int pieRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
	Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return _pieRGBAText(renderer, x, y, rad, start, end, r, g, b, a, 0);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad, Sint16 start, Sint16 end, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return _pieRGBAText(renderer, x, y, rad, start, end, c[0], c[1], c[2], c[3], 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPieRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 rad,
	Sint16 start, Sint16 end, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return _pieRGBAText(renderer, x, y, rad, start, end, r, g, b, a, 1);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int trigonColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color)
{
	Sint16 vx[3];
	Sint16 vy[3];
	...
	return(polygonColorText(renderer,vx,vy,3,color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int trigonRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	...
	return(polygonRGBAText(renderer,vx,vy,3,r,g,b,a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aatrigonColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color)
{
	Sint16 vx[3];
	Sint16 vy[3];
	...
	return(aapolygonColorText(renderer,vx,vy,3,color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aatrigonRGBAText(SDL_Renderer * renderer,  Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	Sint16 vx[3];
	Sint16 vy[3];
	...
	return(aapolygonRGBAText(renderer,vx,vy,3,r,g,b,a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledTrigonColorText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3, Uint32 color)
{
	Sint16 vx[3];
	Sint16 vy[3];
	...
	return(filledPolygonColorText(renderer,vx,vy,3,color));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledTrigonRGBAText(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Sint16 x3, Sint16 y3,
	Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	Sint16 vx[3];
	Sint16 vy[3];
	...
	return(filledPolygonRGBAText(renderer,vx,vy,3,r,g,b,a));
}
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonColorText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return polygonRGBAText(renderer, vx, vy, n, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n)
{
	/*
	* Draw
	*/
...
\returns Returns 0 on success, -1 on failure.
*/
int polygonRGBAText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	/*
	* Draw
	*/
	...
	* Draw
	*/
	result |= polygonText(renderer, vx, vy, n);
...
\returns Returns 0 on success, -1 on failure.
*/
int aapolygonColorText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return aapolygonRGBAText(renderer, vx, vy, n, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int aapolygonRGBAText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int i;
	const Sint16 *x1, *y1, *x2, *y2;
	...
	*/
	result = 0;
	for (i = 1; i < n; i++) {
		result |= _aalineRGBAText(renderer, *x1, *y1, *x2, *y2, r, g, b, a, 0);
		x1 = x2;
		y1 = y2;
		x2++;
		y2++;
	...
	result |= _aalineRGBAText(renderer, *x1, *y1, *vx, *vy, r, g, b, a, 0);
...
*/
int _gfxPrimitivesCompareIntText(const void *a, const void *b)
{
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonRGBAMTText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a, int **polyInts, int *polyAllocated)
{
	int result;
	int i;
	int y, xa, xb;
	...
	*/
	...
	for (y = miny; (y <= maxy); y++) {
		...
		qsort(gfxPrimitivesPolyInts, ints, sizeof(int), _gfxPrimitivesCompareIntText);
		...
		*/
		...
		for (i = 0; (i < ints); i += 2) {
			...
			result |= hlineText(renderer, xa, xb, y);
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonColorText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return filledPolygonRGBAMTText(renderer, vx, vy, n, c[0], c[1], c[2], c[3], NULL, NULL);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int filledPolygonRGBAText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	return filledPolygonRGBAMTText(renderer, vx, vy, n, r, g, b, a, NULL, NULL);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int _HLineTexturedText(SDL_Renderer *renderer, Sint16 x1, Sint16 x2, Sint16 y, SDL_Texture *texture, int texture_w, int texture_h, int texture_dx, int texture_dy)
{
	Sint16 w;
	Sint16 xtmp;
	int result = 0;
...
\returns Returns 0 on success, -1 on failure.
*/
int texturedPolygonMTText(SDL_Renderer *renderer, const Sint16 * vx, const Sint16 * vy, int n,
	...
	*/
	...
	for (y = miny; (y <= maxy); y++) {
		...
		for (i = 0; (i < ints); i += 2) {
			...
			xb = gfxPrimitivesPolyInts[i+1] - 1;
			xb = (xb >> 16) + ((xb & 32768) >> 15);
			result |= _HLineTexturedText(renderer, xa, xb, y, textureAsTexture, texture->w, texture->h, texture_dx, texture_dy);
		}
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int texturedPolygonText(SDL_Renderer *renderer, const Sint16 * vx, const Sint16 * vy, int n, SDL_Surface *texture, int texture_dx, int texture_dy)
{
	/*
	* Draw
	*/
	return (texturedPolygonMTText(renderer, vx, vy, n, texture, texture_dx, texture_dy, NULL, NULL));
}
...
*/
void gfxPrimitivesSetFontText(const void *fontdata, Uint32 cw, Uint32 ch)
{
	int i;
...
*/
void gfxPrimitivesSetFontRotationText(Uint32 rotation)
{
	int i;
...
\returns Returns 0 on success, -1 on failure.
*/
int characterRGBAText(SDL_Renderer *renderer, Sint16 x, Sint16 y, char c, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	SDL_Rect srect;
	SDL_Rect drect;
	int result;
...
\returns Returns 0 on success, -1 on failure.
*/
int characterColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, char c, Uint32 color)
{
	Uint8 *co = (Uint8 *)&color;
	return characterRGBAText(renderer, x, y, c, co[0], co[1], co[2], co[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int stringColorText(SDL_Renderer * renderer, Sint16 x, Sint16 y, const char *s, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return stringRGBAText(renderer, x, y, s, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int stringRGBAText(SDL_Renderer * renderer, Sint16 x, Sint16 y, const char *s, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result = 0;
	Sint16 curx = x;
	Sint16 cury = y;
	...
	while (*curchar && !result) {
		result |= characterRGBAText(renderer, curx, cury, *curchar, r, g, b, a);
		switch (charRotation)
		{
		case 0:
			curx += charWidthLocal;
...
*/
double _evaluateBezierText (double *data, int ndata, double t)
{
	double mu, result;
	int n,k,kn,nn,nkn;
...
\returns Returns 0 on success, -1 on failure.
*/
int bezierColorText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, int s, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
...
\returns Returns 0 on success, -1 on failure.
*/
int bezierRGBAText(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, int s, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int i;
	...
	*/
	t=0.0;
	x1=(Sint16)lrint(_evaluateBezierText(x,n+1,t));
	y1=(Sint16)lrint(_evaluateBezierText(y,n+1,t));
	for (i = 0; i <= (n*s); i++) {
		t += stepsize;
		x2=(Sint16)_evaluateBezierText(x,n,t);
		y2=(Sint16)_evaluateBezierText(y,n,t);
		result |= lineText(renderer, x1, y1, x2, y2);
		x1 = x2;
		y1 = y2;
	}
...
\returns Returns 0 on success, -1 on failure.
*/
int _bresenhamInitializeText(SDL2_gfxBresenhamIterator *b, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2)
{
	int temp;
...
*/
int _bresenhamIterateText(SDL2_gfxBresenhamIterator *b)
{
	if (b==NULL) {
		return (-1);
	}
...
*/
void _murphyParalineText(SDL2_gfxMurphyIterator *m, Sint16 x, Sint16 y, int d1)
{
	int p;
	d1 = -d1;
...
*/
void _murphyIterationText(SDL2_gfxMurphyIterator *m, Uint8 miter,
	...
	Uint16 ml1x, Uint16 ml1y, Uint16 ml2x, Uint16 ml2y)
{
	...
	if (miter > 1) {
		if (m->first1x != -32768) {
			...
			* Lock the surface
			*/
			_bresenhamInitializeText(&b, m2x, m2y, m1x, m1y);
			do {
				pixel(m->renderer, b.x, b.y);
			} while (_bresenhamIterateText(&b)==0);

			_bresenhamInitializeText(&b, m1x, m1y, ml1bx, ml1by);
			do {
				pixel(m->renderer, b.x, b.y);
			} while (_bresenhamIterateText(&b)==0);

			_bresenhamInitializeText(&b, ml1bx, ml1by, ml2bx, ml2by);
			do {
				pixel(m->renderer, b.x, b.y);
			} while (_bresenhamIterateText(&b)==0);

			_bresenhamInitializeText(&b, ml2bx, ml2by, m2x, m2y);
			do {
				pixel(m->renderer, b.x, b.y);
			} while (_bresenhamIterateText(&b)==0);
			...
			py[2] = ml1by;
			py[3] = ml2by;
			polygonText(m->renderer, px, py, 4);
		}
	}
...
*/
void _murphyWidelineText(SDL2_gfxMurphyIterator *m, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 width, Uint8 miter)
{
	...
	for (q = 0; dd <= tk; q++) {	/* outer loop, stepping perpendicular to line */
		...
		_murphyParalineText(m, ptx, pty, d1);	/* call to inner loop - right edge */
		if (q == 0) {
			ml1x = ptx;
			ml1y = pty;
			ml1bx = m->tempx;
		...
		if (d0 < m->kt) {	/* square move */
			...
			if (d1 < m->kt) {	/* normal diagonal */
				...
				d1 += m->kd;
				if (dd > tk) {
					_murphyIterationText(m, miter, ml1bx, ml1by, ml2bx, ml2by, ml1x, ml1y, ml2x, ml2y);
					return;	/* breakout on the extra line */
				}
				_murphyParalineText(m, ptx, pty, d1);
				if (m->oct2 == 0) {
					if (m->quad4 == 0) {
						pty++;
					} else {
...
\returns Returns 0 on success, -1 on failure.
*/
int thickLineColorText(SDL_Renderer *renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 width, Uint32 color)
{
	Uint8 *c = (Uint8 *)&color;
	return thickLineRGBAText(renderer, x1, y1, x2, y2, width, c[0], c[1], c[2], c[3]);
}
...
\returns Returns 0 on success, -1 on failure.
*/
int thickLineRGBAText(SDL_Renderer *renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint8 width, Uint8 r, Uint8 g, Uint8 b, Uint8 a)
{
	int result;
	int wh;
	...
	if ((x1 == x2) && (y1 == y2)) {
		wh = width / 2;
		return boxRGBAText(renderer, x1 - wh, y1 - wh, x2 + width, y2 + width, r, g, b, a);
	}
	...
	*/
	m.renderer = renderer;
	_murphyWidelineText(&m, x1, y1, x2, y2, width, 0);
	_murphyWidelineText(&m, x1, y1, x2, y2, width, 1);
