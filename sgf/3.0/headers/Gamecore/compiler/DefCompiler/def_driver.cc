...
namespace DefCompiler {
	...
	Driver::Driver(SGF::Ast::CAstManager* _Ast)
...
{
	SMF::Debug::debug(SMF::Debug::compilers,__FUNCTION__) << "Driver::error:" << l << " : " << m << std::endl;
	//std::cerr << "Driver::error:" << l << ": " << m << std::endl;
}

void Driver::error(const std::string& m)
{
	SMF::Debug::debug(SMF::Debug::compilers,__FUNCTION__) << "Driver::error: "<< m << std::endl;
