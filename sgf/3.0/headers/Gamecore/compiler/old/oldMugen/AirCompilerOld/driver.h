...
#ifndef OLD_AIR_DRIVER_H
#define OLD_AIR_DRIVER_H
...
public:
    ...
    //class CalcContext& calc;
	 /** Reference to the AirManager context filled during parsing of the
     * expressions. */
	class CAirManager* Air;
};
