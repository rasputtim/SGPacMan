...
public:
    ...
    /// construct a new parser driver context
    Driver(class SGF::Ast::CAstManager* Ast);
     ...
     * ifstream if detection of file reading errors is required.
	...
	class CScanner* lexer;

    /** Reference to the calculator context filled during parsing of the
     * expressions. */
    //class CalcContext& calc;
	 /** Reference to the AstManager context filled during parsing of the
     * expressions. */
	class SGF::Ast::CAstManager* Ast;

	SGF::Ast::CStack *nodes;

	SGF::Ast::CStack *cvalues;
    //* clear de cvalues stack
	void clear_stack ();
