...
#undef YY_DECL
#define YY_DECL    CmdCompiler::Parser::token_type				\
    CmdCompiler::CScanner::lex(				\
	CmdCompiler::Parser::semantic_type* yylval,		\
	CmdCompiler::Parser::location_type* yylloc		\
    )
...
class CScanner : public CmdFlexLexer {
