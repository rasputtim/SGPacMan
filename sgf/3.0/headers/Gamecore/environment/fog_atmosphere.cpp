...
Atmosphere(){
	fog = new CBitmap( 50, 50 );
	fog->fill( CBitmap::MaskColor );
	fog->circleFill( 25, 25, 20, CBitmap::makeColor( 0xbb, 0xbb, 0xcc ) );
...
void FogAtmosphere::drawForeground(CBitmap * work, int x){
}

void FogAtmosphere::drawBackground(CBitmap * work, int x){
}
	
void FogAtmosphere::drawFront(CBitmap * work, int x){
}

void FogAtmosphere::drawScreen(CBitmap * work, int x){
